...
$base_url = '/phpassignment/phpassignment2/sportspro/';
; // starts with /, no trailing /
...
<div class="card shadow mb-4">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="<?= $base_url ?>/views/technicians/index.php" class="list-group-item list-group-item-action">
            Manage Technicians
        </a>

        <a href="<?= $base_url ?>/views/customers/index.php" class="list-group-item list-group-item-action">
            Manage Customers
        </a>
